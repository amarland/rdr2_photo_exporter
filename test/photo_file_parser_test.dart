...
void main() {
  group('valid photo files are parsed successfully', () {
    test('Grand Theft Auto V', () async {
      final photo = await parsePhotoFile('./test/res/PGTA5_1');
    ...
    test('Red Dead Redemption II', () async {
      final photo = await parsePhotoFile('./test/res/PRDR3_1');
